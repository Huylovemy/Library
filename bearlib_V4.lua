...
local Bearlib = {
    Themes = {
            ...
            ["Color Theme"] = Color3.fromRGB(132, 112 ,255), 
...
function Bearlib:MakeWindow(Configs)
	...
	local MainFrame = InsertTheme(Create("ImageButton", ScreenGui, {
		...
		BackgroundColor3 = Color3.fromRGB(0, 0, 0), -- Màu đen
        BackgroundTransparency = 0.3, -- Hơi trong suốt (0 = đục, 1 = hoàn toàn trong suốt)
		Name = "Hub"
	}), "Main")
	...
	local MainStroke = Make("Stroke", MainFrame)
        MainStroke.Thickness = 1.5 -- Độ dày của khung (bạn có thể chỉnh lên 2 nếu muốn dày hơn)
        MainStroke.ApplyStrokeMode = Enum.ApplyStrokeMode.Border
        MainStroke.Thickness = 1.8 -- Độ dày của khung
        MainStroke.Thickness = 1.8 -- Bạn có thể chỉnh độ dày tùy ý
	...
	local Separator = InsertTheme(Create("Frame", Components, {
    Size = UDim2.new(0, 1, 1, -TopBar.Size.Y.Offset), -- Độ rộng 1 pixel, chiều cao đầy đủ (trừ TopBar)
    Position = UDim2.new(0, Bearlib.Save.TabSize, 1, 0), -- Đặt tại vị trí kết thúc của dải Tab
    AnchorPoint = Vector2.new(0, 1),
    BackgroundColor3 = Theme["Color Stroke"], -- Sử dụng màu viền từ Theme
    BorderSizePixel = 0,
    Name = "Separator"
}), "Stroke")
	...
	local function ControlSize()
		...
		Separator.Position = UDim2.new(0, ControlSize2.Position.X.Offset, 1, 0) 
    
    -- Cập nhật kích thước khu vực nội dung (Containers) và khung chính
    Containers.Size = UDim2.new(1, -MainScroll.Size.X.Offset, 1, -TopBar.Size.Y.Offset)
    MainFrame.Size = ControlSize1.Position
	end
	...
	function Window:MinimizeBtn()
		...
		if Minimized then
			MinimizeButton.Image = "rbxassetid://134852113716171"
	...
	function Window:MakeTab(paste, Configs)
		...
		function Tab:AddDiscordInvite(Configs)
			...
			local function createDiscordCard(cardConfigs, layoutOrder)
				...
				local ServerName = InsertTheme(Create("TextLabel", Card, {
					...
					Text = BName,
					Font = Enum.Font.GothamBold,
					TextColor3 = Theme["Color Discord Text"] or Theme["Color Text"]
				}), "Text")
				...
				if Online or TotalMembers then
					...
					local function AddStat(Color, Text)
						...
						InsertTheme(Create("TextLabel", Stat, {
							...
							Text = Text,
							Font = Enum.Font.Gotham,
							TextColor3 = Theme["Color Discord Stats"] or Theme["Color Dark Text"]
						}), "DarkText")
					end
        ...
        -- ==================== DISCORD INVITE OLD (GIỮ LẠI CHO TƯƠNG THÍCH) ====================
		function Tab:AddDiscordInviteOld(Configs)
			...
			local FrameHolder = InsertTheme(Create("Frame", InviteHolder, {
				...
				Position = UDim2.new(0, 0, 1),
				BackgroundColor3 = Theme["Color Hub 2"]
			}), "Frame")Make("Corner", FrameHolder)Make("Stroke", FrameHolder)
